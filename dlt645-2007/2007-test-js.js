 ...
 * @LastEditors: name
 * @LastEditTime: 2026-01-08 16:39:35
 */
// import DL645_2007, { DL645_2007_DataId } from './dl645-2007';
const DL645_2007 = require('./dl645-2007.js').default; // 核心类是默认导出，需取 .default
const { DL645_2007_DataId,DL645ControlCode, PowerProtectCommand,SwitchCommand  } = require('./dl645-2007.js'); // 手动提取命名导出（核心代码已导出，仅注释未解除，后面会处理）
