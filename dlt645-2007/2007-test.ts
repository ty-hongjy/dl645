/*
 * @Description: DL/T645-2007 命令验证测试程序
 * 验证地址202411110002的电压/总电能命令是否匹配预期值
 * @Autor: hongjy
 * @Date: 2026-02-13 14:30:33
 * @LastEditors: name
 * @LastEditTime: 2026-04-17 10:19:51
 */
...
const EXPECTED_COMMANDS = {
  ...
  A_CURRENT: '68020011112420681104333435351E16', // 剔除帧头后的A相电流命令
  B_VOLTAGE: '68020011112420681104333534351E16', // B相电压
  C_VOLTAGE: '68020011112420681104333634351F16', // C相电压
  TOTAL_ENERGY: '68020011112420681104333334331A16',  // 总电能
  COMBINED_TOTAL_ACTIVE_ENERGY_CONSUMPTION: '68020011112420681104333333331916', // 组合有功总能耗   组合有功总能耗命令：68020011112420681104333333331916
...
function runCommandTests() {
  ...
  testCommandMatch(
    ...
    'A相电流',
    EXPECTED_COMMANDS.A_CURRENT
  );
  
  testCommandMatch(
    DL645_2007_DataId.COMBINED_TOTAL_ACTIVE_ENERGY_CONSUMPTION,
    '组合有功总能耗',
    EXPECTED_COMMANDS.COMBINED_TOTAL_ACTIVE_ENERGY_CONSUMPTION
  );
